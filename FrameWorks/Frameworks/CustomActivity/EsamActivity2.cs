...
{
    public abstract class EsamActivity2 : Activity, IHandleMessage
    {
        private string mId;
        private int mCount;
        ...
        private static void DoInput(EsamActivity2 instance)
        {
        ...
        private static void HandleResultInner(EsamActivity2 instance, Result result)
        {
        ...
        private Result defaultInputPassword()
        {
            ...
            while (true)
            {
                ...
                //Log.Info("nRet = " + nRet + "=== strPin = " + strPin);
                ...
                {
                    //if (string.Compare("0000000000000000", strPin) == 0)
                    //{
                    //    Log.Info("strPin = " + strPin);
                    //    Password = strPin;
