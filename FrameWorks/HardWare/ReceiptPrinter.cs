...
namespace Landi.FrameWorks.HardWare
{
    public class ReceiptPrinter : HardwareBase<ReceiptPrinter, ReceiptPrinter.Status>, Landi.FrameWorks.IManagedHardware
    {
        ...
        protected static extern int Epson532OpenPrinter(string port_name, int bps);
        [DllImport("epson532.dll")]
        protected static extern int Epson532CPrint(string sPrintData);
        [DllImport("epson532.dll")]
        protected static extern int Epson532Cut();
        [DllImport("epson532.dll")]
        protected static extern int Epson532GetPrinterStatus();
        [DllImport("epson532.dll")]
        protected static extern int Epson532BlackMark();
        [DllImport("epson532.dll")]
        protected static extern int Epson532CloseCom();
        [DllImport("epson532.dll")]
        protected static extern int Epson532FeedLine(int nLineNum);
        [DllImport("epson532.dll")]
        protected static extern int Epson532PrintImageFromFileName(string filename);
        [DllImport("epson532.dll")]
        protected static extern int Epson532SetPrintPosition(int mode);
        [DllImport("epson532.dll")]
        protected static extern int Epson532SetAbsPrintPosition(int mode);
        #endregion
        ...
        public static Status GetStatus()
        {
            ...
            try
            {
                ...
                if (ret == Status.OUT_OF_PAPER || ret == Status.PAPER_FEW)
                    ret = Status.SUCC;
                return ret;
            }
            catch (System.Exception e)
