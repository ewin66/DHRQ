...
namespace Landi.FrameWorks.HardWare
{
    public class CashCode : HardwareBase<CashCode, CashCode.Status>, Landi.FrameWorks.IManagedHardware
    {
        ...
        protected static extern int EA_CASHCODE_Reset();
        [DllImport("CashCode.dll")]
        protected static extern int EA_CASHCODE_Getversion(ref string version);
        [DllImport("CashCode.dll")]
        protected static extern int EA_CASHCODE_Getbilltype();
        [DllImport("CashCode.dll")]
        protected static extern int EA_CASHCODE_EnableBill(byte type, byte escrow);
        [DllImport("CashCode.dll")]
        protected static extern int EA_CASHCODE_Poll();
        [DllImport("CashCode.dll")]
        protected static extern int EA_CASHCODE_ReturnBill();
        [DllImport("CashCode.dll")]
        protected static extern int EA_CASHCODE_StackBill();
        [DllImport("CashCode.dll")]
        protected static extern int EA_CASHCODE_HoldBill();
        [DllImport("CashCode.dll")]
        protected static extern int EA_CASHCODE_SetComm(string portName, int bps);
        [DllImport("CashCode.dll")]
        protected static extern int EA_CASHCODE_ACK();
        [DllImport("CashCode.dll")]
        protected static extern int EA_CASHCODE_Close();
        [DllImport("CashCode.dll")]
