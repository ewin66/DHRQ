...
namespace Landi.FrameWorks.HardWare
{
    public class ScanIS4225 : HardwareBase<ScanIS4225, ScanIS4225.Status>, Landi.FrameWorks.IManagedHardware
    {
        ...
        protected static extern int EA_Scan_Openport(string portName);
        [DllImport("Scanbar.dll")]
        protected static extern int EA_Scan_ScanPage(StringBuilder code, long waitTime);
        [DllImport("Scanbar.dll")]
        protected static extern int EA_Scan_GetStatus();
        [DllImport("Scanbar.dll")]
        protected static extern int EA_Scan_Closeport();
        #endregion
