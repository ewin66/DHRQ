...
namespace Landi.FrameWorks.HardWare
{
    public class InvoicePrinter : HardwareBase<InvoicePrinter, InvoicePrinter.Status>, Landi.FrameWorks.IManagedHardware
    {
        ...
        protected static extern int EpsonOpenPrinter(string port_name, int bps);
        [DllImport("EpsonPrinter.dll")]
        protected static extern int EpsonCPrint(string szPrintData);
        [DllImport("EpsonPrinter.dll")]
        protected static extern int EpsonEPrint(string szPrintData);
        [DllImport("EpsonPrinter.dll")]
        protected static extern int EpsonPrinterBeep();
        [DllImport("EpsonPrinter.dll")]
        protected static extern int EpsonSetLineWidth(int nWidth);
        [DllImport("EpsonPrinter.dll")]
        protected static extern int EpsonUnderLine(int nEnable);
        [DllImport("EpsonPrinter.dll")]
        protected static extern int EpsonRedPrint();
        [DllImport("EpsonPrinter.dll")]
        protected static extern int EpsonDoubleWidth();
        [DllImport("EpsonPrinter.dll")]
        protected static extern int EpsonCancelDoubleWidth();
        [DllImport("EpsonPrinter.dll")]
        protected static extern int EpsonCut();
        [DllImport("EpsonPrinter.dll")]
        protected static extern int EpsonSemiCut();
        [DllImport("EpsonPrinter.dll")]
        protected static extern int EpsonFeedLine(int nLineNum);
        [DllImport("EpsonPrinter.dll")]
        protected static extern int EpsonBackLine(int nLineNum);
        [DllImport("EpsonPrinter.dll")]
        protected static extern int EpsonGetPrinterStatus();
        [DllImport("EpsonPrinter.dll")]
        protected static extern int EpsonBlackMark();
        [DllImport("EpsonPrinter.dll")]
        protected static extern int EpsonCloseCom();
        [DllImport("EpsonPrinter.dll")]
        protected static extern int EpsonGetSensorStatus();
        [DllImport("EpsonPrinter.dll")]
        protected static extern int EpsonSetBlackMark(BlackPosition position,int len);
        [DllImport("EpsonPrinter.dll")]
        protected static extern int EpsonSetBlackMark(int iInn);
        [DllImport("EpsonPrinter.dll")]
        protected static extern int EpsonSetRowDistance(int iInDistance);
        #endregion
