...
namespace Landi.FrameWorks.HardWare
{
    public class Esam : HardwareBase<Esam, Esam.Status>, Landi.FrameWorks.IManagedHardware
    {
        #region Esam.dll
        [DllImport("ESAM.DLL")]
        protected static extern int ESAM_Open(string port_name, int bps/*= 57600*/);
        [DllImport("ESAM.DLL")]
        protected static extern int ESAM_Close();
        [DllImport("ESAM.DLL")]
        protected static extern int ESAM_GetVersion(string pVersion);
        [DllImport("ESAM.DLL")]
        protected static extern int ESAM_GetStatus();
        [DllImport("ESAM.DLL")]
        protected static extern int ESAM_DownloadKey(byte[] pMainKey);
        [DllImport("ESAM.DLL")]
        protected static extern int ESAM_DownloadSectKey(int nIndex, byte[] pSectKey, int nKeyLen);
        [DllImport("ESAM.DLL")]
        protected static extern int ESAM_SetMaxPIN(int nMaxSize);
        [DllImport("ESAM.DLL")]
        protected static extern int ESAM_SetKeyLen(int nKeyLength);
        [DllImport("ESAM.DLL")]
        protected static extern int ESAM_ActiveKey(int nMasterKeyNO, int nWorkKeyNO);
        [DllImport("ESAM.DLL")]
        protected static extern int ESAM_CalcMAC(byte[] pMacKey, byte[] pData, int nDataLen, byte[] MAC);
        [DllImport("ESAM.DLL")]
        protected static extern int ESAM_GetPIN(byte[] pPinKey, string pszCardNO, int nPwdLen, ref byte pKey, byte[] PIN);
        [DllImport("ESAM.DLL")]
        protected static extern int ESAM_Encrypt(byte[] pData, int nDataLen, byte[] pEncyptedData);
        [DllImport("ESAM.DLL")]
        protected static extern int ESAM_Decrypt(byte[] pData, int nDataLen, byte[] pDecyptedData);
        [DllImport("ESAM.DLL")]
        protected static extern int ESAM_GetWorkMode();
        [DllImport("ESAM.DLL")]
        protected static extern int ESAM_SetWorkMode(int nNewValue);
        [DllImport("ESAM.DLL")]
        protected static extern int ESAM_UpdateWorkKey(int nWorkKeyNO, byte[] pEncryptKeyData);
        [DllImport("ESAM.DLL")]
        protected static extern int ESAM_CancelCommand();

        [DllImport("ESAM.DLL")]
        protected static extern int ESAM_EncryptData(byte[] pSrcData, int nLen, byte[] pDestData);
        [DllImport("ESAM.DLL")]
        protected static extern int ESAM_DecryptData(byte[] pSrcData, int nLen, byte[] pDestData);
        [DllImport("ESAM.DLL")]
        protected static extern int ESAM_GenerateMAC(byte[] pSrcData, int nLen, byte[] pMAC);
        [DllImport("ESAM.DLL")]
        protected static extern int ESAM_ReadPINSecureANSI(string pszCardNO);
        [DllImport("ESAM.DLL")]
        protected static extern int ESAM_GetNextKey();
        [DllImport("ESAM.DLL")]
        protected static extern int ESAM_GetPINBLOCK(byte[] PIN_BLOCK);
        [DllImport("ESAM.DLL")]
        protected static extern int ESAM_SetMasterkeyNO(int nMasterKeyNO);
        [DllImport("ESAM.DLL")]
        protected static extern int ESAM_UserEncrypt(int nKeyID, byte[] pData, int nDataLen, byte[] pEncyptedData);
        [DllImport("ESAM.DLL")]
        protected static extern int ESAM_UserDecrypt(int nKeyID, byte[] pData, int nDataLen, byte[] pDecyptedData);
        #endregion
