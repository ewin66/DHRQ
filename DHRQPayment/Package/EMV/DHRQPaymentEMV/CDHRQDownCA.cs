...
{
    class CDHRQDownCA : DHRQPaymentPay
    {
        /// <summary>
        ...
        /// 下载所有CA详细数据
        /// </summary>
        private byte[] m_downCAAll = new byte[8 * 1024];
        /// <summary>
        /// 所有CA详细数据长度
        /// </summary>
        ...
        protected TransResult CADown()
        {
            ...
            try
            {
                foreach (CaItem item in m_caList)
                {
                    ...
                    writelen = m_downCAItem.Length;
                    deslen = m_downCAAll.Length;
                    writepos = m_nAllCA;
            ...
            {
                Log.Error("DownLoadCA CADown Err" + writelen + "=" + deslen + "-" + writepos + "  |index = " + index, ex);
                throw ex;
            }
                ...
                case 0:
                    {
                        ...
                        SendPackage.SetArrayData(62, Encoding.Default.GetBytes(strCount), 0, 3);
                    } break;
                case 1:
                    {
                        SendPackage.SetString(0, "0800");
                        SendPackage.SetString(60, "00" + GetBatchNo() + "370");
                        SendPackage.SetArrayData(62, m_downCA);
                    } break;
                case 2:
                    {
                        SendPackage.SetString(0, "0800");
                ...
                case 1:
                    {
                        ...
                        if (bField62[0] == 0x31)
                        {
                            m_downCAItem = new byte[bField62.Length - 1];
                            Array.Copy(bField62, 1, m_downCAItem, 0, bField62.Length - 1);
