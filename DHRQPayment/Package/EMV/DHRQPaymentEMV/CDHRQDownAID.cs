...
{
    class CDHRQDownAID : DHRQPaymentPay
    {
        /// <summary>
        /// 下载参数步骤0-下载 1-结束
        /// </summary>
        ...
        public bool DownAID()
        {
            ...
            {
                result = false;
                Log.Error("[CPowerDownAID][DownAID]Error", ex);
            }
                ...
                case 1:
                    {
                        ...
                        SendPackage.SetArrayData(62, m_downAID);
                    }
                    break;
                case 2:
                    {
                ...
                case 1:
                    {
                        ...
                        if (bField62[0] == 0x31)
                        {
                            m_downAIDItem = new byte[bField62.Length - 1];
                            Array.Copy(bField62, 1, m_downAIDItem, 0, bField62.Length - 1);
                        }
                    }
                    break;
                case 2:
